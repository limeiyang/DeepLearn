...
class Layer(object):
    ...
    def set_output(self, data):
        ...
        '''
        # 原来-----
        #for i in range(len(data)):  ########-2自加 nodes0到5为Node nodes6为ConstNode
        #    self.nodes[i].set_output(data[i])
        # -----
        # 改--
        for i in range(len(self.nodes)-1):########-2自加 nodes0到5为Node nodes6为ConstNode
            self.nodes[i].set_output(data[i])
        # --
...
class Network(object):
    ...
    def calc_delta(self, label):
        ...
        # --原来--
        #for i in range(len(label)):########------- -6 out-put_nodes[0]和[1]为Node，[2]为ConstNode
        #    output_nodes[i].calc_output_layer_delta(label[i])
        # -------
        # 改
        for i in range(len(output_nodes)-1):########------- -6 out-put_nodes[0]和[1]为Node，[2]为ConstNode
            output_nodes[i].calc_output_layer_delta(label[i])
        # --
